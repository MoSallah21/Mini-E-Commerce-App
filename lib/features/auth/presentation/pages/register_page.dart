...
class RegisterPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => RegisterState(registerUseCase: di.sl(), signInWithGoogleUseCase: di.sl()),
...
class _RegisterPageContentState extends State<RegisterPageContent>
      ...
      builder: (context, registerState, child) {
        return Container(
          ...
          child: TextFormField(
            ...
            textInputAction: TextInputAction.next,
            style: const TextStyle(fontSize: 16),
            onChanged: registerState.setEmail,
            decoration: InputDecoration(
              labelText: 'Email',
      ...
      builder: (context, registerState, child) {
        return Container(
          ...
          child: TextFormField(
            ...
            textInputAction: TextInputAction.next,
            style: const TextStyle(fontSize: 16),
            onChanged: registerState.setPassword,
            decoration: InputDecoration(
              labelText: 'Password',
              hintText: '••••••••',
              prefixIcon: Container(
      ...
      builder: (context, registerState, child) {
        return Container(
          ...
          child: TextFormField(
            ...
            style: const TextStyle(fontSize: 16),
            onChanged: registerState.setConfirmPassword,
            decoration: InputDecoration(
              ...
              suffixIcon: IconButton(
                ...
                onPressed: registerState.toggleConfirmPasswordVisibility,
              ),
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(16),
                borderSide: BorderSide.none,
        ...
        return SizedBox(
          ...
          child: ElevatedButton(
            onPressed: registerState.isLoading
              ...
              final success = await registerState.register();
              if (success) {
        ...
        Row(
          ...
          children: [
            Consumer<RegisterState>(
              builder: (BuildContext context, RegisterState value, Widget? child) {
  ...
  void _showSocialRegister(String provider) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Register with $provider'),
